...
interface parentRegProps {
  history: History;
  location: Location;
}

interface parentRegState {
  page: string;
...
export class parentReg extends React.Component<
  parentRegProps,
  parentRegState
> {
  registerData: {
  ...
  examinations: any;
  topicList: any;
  constructor(props: parentRegProps) {
    super(props);
    this.examinations = [];
    this.topicList = [];
    this.registerData = {
  ...
  public render() {
    return (
      <div className="address-container registered">
        ...
        >
          <div className="nav-title">注册知者-家长</div>
        </NavBar>
        <div
          style={{ height: pageheight, width: pagewidth, overflow: "scroll" }}
        >
