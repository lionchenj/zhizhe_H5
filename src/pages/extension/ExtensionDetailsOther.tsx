...
interface ExtensionDetailsOtherProps {
  history: History;
  location: Location;
}

interface ExtensionDetailsOtherState {
  title: string;
  orderid: string;
  isHome: boolean;
  status: string;
...
export class ExtensionDetailsOther extends React.Component<ExtensionDetailsOtherProps, ExtensionDetailsOtherState> {
  lv: any;
  orderid: any;
  isStatus: boolean;
  isCollection: boolean;
  constructor(props: ExtensionDetailsOtherProps) {
    super(props);
    this.isStatus = false;
